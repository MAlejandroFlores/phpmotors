...
<form action="/phpmotors/vehicles/index.php" method="POST">
    ...
    <input type="text" id="inv_make" name="invMake"><br><br>
    <label for="inv_model">Model</label><br>
    <input type="text" id="inv_model" name="invModel"><br><br>
    <label for="inv_description">Description</label><br>
    <input type="text" id="inv_description" name="invDescription"><br><br>
    <label for="inv_image">Image Path</label><br>
    <input type="text" id="inv_image" name="invImage"><br><br>
    <label for="inv_thumbnail">Thumbnail Path</label><br>
    <input type="text" id="inv_thumbnail" name="invThumbnail"><br><br>
    <label for="inv_price">Price</label><br>
    <input type="text" id="inv_price" name="invPrice"><br><br>
    <label for="inv_stock"># In Stock</label><br>
    <input type="text" id="inv_stock" name="invStock"><br><br>
    <label for="inv_color">Color</label><br>
    <input type="text" id="inv_color" name="invColor"><br><br>
